...
switchMover.name = "Sardine7/SwitchMover"
switchMover.depth = -9999
switchMover.nodeVisibility = "never"
switchMover.nodeLimits = {1, 1}
switchMover.minimumSize = {16, 16}
switchMover.fieldInformation = {
    theme = {
        options = themes,
        editable = false
    },
...
switchMover.placements = {}

for i, theme in ipairs(themes) do
    switchMover.placements[i] = {
...
function switchMover.sprite(room, entity)
    local sprites = {}
...
function switchMover.selection(room, entity)
    local x, y = entity.x or 0, entity.y or 0
